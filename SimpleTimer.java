...
{
    private long lastMark = System.currentTimeMillis() / 1000;
    private long startTime;
    
    public SimpleTimer(long offSet)
    {
        startTime = offSet;
    }
    ...
    public void mark()
    {
        lastMark = System.currentTimeMillis() / 1000;
    }
    ...
    {
        return (int) (System.currentTimeMillis() / 1000 - lastMark + startTime);
    }
